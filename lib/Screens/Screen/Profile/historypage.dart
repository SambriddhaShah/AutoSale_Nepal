...
class _HistoryPageState extends State<HistoryPage> {
  ...
  StreamSubscription<List<ApprovedListing>>?
      _listingsdeletedinterestedSubscription;

  bool _isLoadinginterested = true;
  List<ApprovedListing> _listingsinterested = [];
  List<ApprovedListing> _listingsdeleted = [];
  bool show = true;
  bool showw = true;
  bool showww = true;
  ...
  void setmyDataapproved() async {
    ...
    _listingsapprovedinterestedSubscription =
        FirebaseService.getSelledListingsForUser().listen(
      (listings) {
  ...
  void setmyDatadeleted() async {
    // Assuming this is in the main method or initState() of a StatefulWidget
    _listingsdeletedinterestedSubscription =
        FirebaseService.getdeletedListingsForUser().listen(
      (listings) {
        // Update the variable with the latest data
        setState(() {
          _listingsdeleted = listings;
          _isLoadingdeleted = false;
          print('the listing is $_listingsdeleted');
          _listingsdeletedinterestedSubscription?.cancel();
        });
      },
      onError: (error) {
        // Handle any errors
        print('Error fetching deleted listings: $error');
        ToastMessage.showMessage('error occured fetching data $error');
      },
      onDone: () {
        setState(() {
  ...
  void setmyDatainterested() {
    ...
    _listingsinterestedSubscription =
        FirebaseService.getBoughtListingsForUser().listen(
      (listings) {
        // Update the variable with the latest data
        setState(() {
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child:
                          Text("Deleted History", style: Styles.textBlack20B),
                    ),
                  ),
                ),
                IconButton(
                          ...
                          : _listingsdeleted.isEmpty
                              ...
                              : Container(
                                  ...
                                  child: ListView.builder(
                                      ...
                                      // shrinkWrap: true,
                                      // physics: const NeverScrollableScrollPhysics(),
                                      itemCount: _listingsdeleted.length,
                                      itemBuilder: (BuildContext context,
                                          int childIndex) {
                                        return Container(
                                          //  color: ,
                                                ...
                                                child: ListTile(
                                                  ...
                                                  title: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                          "Rs.${_listingsdeleted[childIndex].price}",
                                                          style: Styles
                                                              .textBlack14B,
                                                          overflow: TextOverflow
                                                              .ellipsis),
