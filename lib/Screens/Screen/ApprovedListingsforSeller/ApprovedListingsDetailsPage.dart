...
class ApprovedListingsDetailsSellerPage extends StatefulWidget {
  ApprovedListing data;
  ApprovedListingsDetailsSellerPage({super.key, required this.data});

  @override
  State<ApprovedListingsDetailsSellerPage> createState() =>
      _ApprovedListingsDetailsSellerPageState();
}

class _ApprovedListingsDetailsSellerPageState
    extends State<ApprovedListingsDetailsSellerPage> {
        ...
        body: SingleChildScrollView(
          child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Text('Purchasing Customer',
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              children: [
                                Text(
                                  data!.isPaid == true ? "Done" : "Not Done",
                                  // "Total Km's :",
                                  style: Styles.textBlack15BNormal,
                                ),
                                SizedBox(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                (data!.isPaid == "true" || data!.isCOD == 'true') &&
                        data!.isCompleted == "false"
                    ? ElevatedButton(
                        onPressed: () {
            ...
            return WillPopScope(
              ...
              child: AlertDialog(
                    ...
                    Row(
                      children: [
                        ElevatedButton(
                          ...
                          child: Center(
                              child:
                                  Text('Yes', style: Styles.buttonTextStyle)),
                          onPressed: () {
                            FirebaseService
                                    .moveApprovedListingToHistoryAndDelete(
                                        data!.id)
                                .then((value) => {
                                      ToastMessage.showMessage('Sold'),
                  ...
                  content: Padding(
                    ...
                    child: Text(
                      'Have You Received the Payment and Want to Complete the Listing?',
                      style: Styles.textWhite24Normal,
                    ),
                  )),
            );
          });
