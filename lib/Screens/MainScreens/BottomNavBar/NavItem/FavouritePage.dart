...
class _FavouritePageState extends State<FavouritePage> {
  ...
  void setmyDataapproved() async {
    ...
    _listingsapprovedinterestedSubscription =
        FirebaseService.getApprovedListingsForBuyer().listen(
      (listings) {
  ...
  void setmyDatainterested() {
    ...
    _listingsinterestedSubscription =
        FirebaseService.getListingsForinterested().listen(
      (listings) {
        // Update the variable with the latest data
        setState(() {
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child:
                          Text("Approved Listings", style: Styles.textBlack20B),
                    ),
                  ),
                ),
                IconButton(
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Text("Interested Listings",
