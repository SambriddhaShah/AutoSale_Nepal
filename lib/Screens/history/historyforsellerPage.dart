...
class historyforsellerPage extends StatefulWidget {
  ApprovedListing data;
  historyforsellerPage({super.key, required this.data});

  @override
  State<historyforsellerPage> createState() => _historyforsellerPageState();
}

class _historyforsellerPageState extends State<historyforsellerPage> {
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Text('Purchased By', style: Styles.textBlack24B),
                    ),
                  ),
                ),
                IconButton(
