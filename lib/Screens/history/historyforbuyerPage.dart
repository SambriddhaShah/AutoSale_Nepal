...
class historyforbuyerPage extends StatefulWidget {
  ApprovedListing data;
  historyforbuyerPage({super.key, required this.data});

  @override
  State<historyforbuyerPage> createState() => _historyforbuyerPageState();
}

class _historyforbuyerPageState extends State<historyforbuyerPage> {
